...
| --- | --- | --- | --- |
| Monthly | USD | US$5 | One month |
| Annual | USD | US$30 | One year |

The annual plan saves US$30, or 50%, compared with twelve monthly payments (US$60). Both plans are recurring; users can cancel future renewal from Stripe Customer Portal. The seven-day free trial starts after email verification using server time, requires no payment method, and does not turn into a paid subscription without Checkout.
