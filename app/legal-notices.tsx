  ...
  en: {
    ...
    privacy: {
      ...
      sections: [
        ...
        ['Voice coaching and music', 'Spoken cues use your device or browser speech service. Optional voice commands start only when you press Talk to coach and may send audio to your browser’s speech provider for recognition. TrainWell does not save microphone recordings or transcripts. You can use the same coach controls as buttons without a microphone. Background music is generated on your device and can be muted independently.'],
  ...
  zh: {
    ...
    privacy: {
      ...
      sections: [
        ...
        ['语音指导与音乐', '语音提示使用设备或浏览器的语音服务。可选语音指令仅在点击“对教练说话”后启动，可能向浏览器语音服务商发送音频进行识别。悦练不保存麦克风录音或转写内容。无需麦克风也可通过按钮使用相同的教练功能。背景音乐在本机生成，可以单独关闭。'],
