  ...
  en: {
    ...
    privacy: {
      ...
      sections: [
        ...
        ['Payment information', 'Stripe hosts secure checkout and billing management. Stripe receives your email and billing identifiers; TrainWell stores customer, subscription, event and membership records, but never card details. Real payments use live Checkout. Any separately labeled sandbox transactions are tests and do not grant live paid membership.'],
  ...
  zh: {
    ...
    privacy: {
      ...
      sections: [
        ...
        ['支付信息', 'Stripe 托管安全支付和账单管理。Stripe 接收邮箱和账单标识，悦练保存客户、订阅、事件和会员记录，但不保存银行卡信息。真实付款通过正式支付页面完成，另行标注的沙盒交易属于测试，不会授予正式付费会员权限。'],
