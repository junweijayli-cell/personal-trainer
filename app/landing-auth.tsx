...
const copy = {
  en: {
    ...
    forgot: 'Forgot password?', forgotTitle: 'Reset your password', forgotCopy: 'Enter your account email. If it exists, Relay will send a secure reset link.', sendReset: 'Send reset email', resetSent: 'If that address has an account, a reset email is on its way.', resetTitle: 'Choose a new password', resetCopy: 'Create a new password for your Relay account.', savePassword: 'Save new password', resetDone: 'Password updated. Sign in with your new password.',
  ...
  zh: {
    ...
    forgot: '忘记密码？', forgotTitle: '重置密码', forgotCopy: '输入账户邮箱。如果账户存在，Relay 会发送安全重置链接。', sendReset: '发送重置邮件', resetSent: '如果此邮箱存在账户，重置邮件正在发送。', resetTitle: '设置新密码', resetCopy: '为你的 Relay 账户创建新密码。', savePassword: '保存新密码', resetDone: '密码已更新，请使用新密码登录。',
