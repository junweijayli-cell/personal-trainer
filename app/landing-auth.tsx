...
const copy = {
  en: {
    ...
    monthly: 'Monthly', annual: 'Annual', bestValue: 'BEST VALUE', priceTbd: 'Price coming soon', planMonthly: 'US$10 billed monthly. Automatically renews until canceled.', planAnnual: 'US$60 billed yearly. Automatically renews until canceled.', startTrial: 'Start free trial',
  ...
  zh: {
    ...
    monthly: '月付', annual: '年付', bestValue: '最超值', priceTbd: '价格即将公布', planMonthly: '每月扣款 US$10，自动续订，可随时取消。', planAnnual: '每年扣款 US$60，自动续订，可随时取消。', startTrial: '开始免费试用',
