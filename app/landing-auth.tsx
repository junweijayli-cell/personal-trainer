...
const copy = {
  en: {
    ...
    trialKicker: 'MEMBERSHIP', trialTitle: 'Seven days to feel the difference', trialCopy: 'Explore the complete product free. After your trial, choose daily, monthly or annual access. No card is required to begin.',
    daily: 'Daily', planDaily: 'US$1 every day until canceled. Manage renewal in your account.', monthly: 'Monthly', annual: 'Annual', bestValue: 'BEST VALUE', priceTbd: 'Price coming soon', planMonthly: 'US$10 billed monthly. Automatically renews until canceled.', planAnnual: 'US$60 billed yearly. Automatically renews until canceled.', startTrial: 'Start free trial',
